EPUBJS.reader = {}, EPUBJS.reader.plugins = {}, function (a, b) { var c = (a.ePubReader || {}, a.ePubReader = function (a, b) { return new EPUBJS.Reader(a, b) }); "function" == typeof define && define.amd ? define(function () { return Reader }) : "undefined" != typeof module && module.exports && (module.exports = c) }(window, jQuery),
    ...
    // EPUBJS.Reader.prototype.addBookmark = function (a) { var b = this.isBookmarked(a); b > -1 || (this.settings.bookmarks.push(a), this.trigger("reader:bookmarked", a)) },
    EPUBJS.Reader.prototype.addBookmark = function (a) { this.trigger("reader:bookmarked", a); },

    EPUBJS.Reader.prototype.removeBookmark = function (a) {  this.trigger("reader:unbookmarked", a) },
    
    EPUBJS.Reader.prototype.addSearch=function(a){console.log(a);this.trigger("reader:addSearch",a)},
    ...
    EPUBJS.reader.BookmarksController = function () { var a = this.book, b = $("#bookmarksView"), c = b.find("#bookmarks"), d = document.createDocumentFragment(), e = function () { b.show() }, f = function () { b.hide() }, g = 0, h = function (b) { var c = document.createElement("li"), d = document.createElement("a"); return c.id = b.id, c.classList.add("list_item"), d.textContent = b.title, d.href = b.epubcfi, d.classList.add("bookmark_link"), d.addEventListener("click", function (b) { var c = this.getAttribute("href"); a.gotoCfi(c), b.preventDefault() }, !1), c.appendChild(d), g++ , c }; return this.settings.bookmarks.forEach(function (a) { var b = h(a); d.appendChild(b) }), c.append(d), this.on("reader:bookmarked", function (a) { var b = h(a); c.append(b) }), this.on("reader:unbookmarked", function (a) { var b = $("#" + a.id); b.remove() }), { show: e, hide: f } },

    EPUBJS.reader.SearchController=function(){var a=this.book,b=$("#searchView"),c=b.find("#searchResults"),d=document.createDocumentFragment(),e=function(){b.show()},f=function(){b.hide()},h=function(b){var c=document.createElement("li"),d=document.createElement("a");return c.id=b.id?b.id:"0",c.classList.add("list_item"),d.textContent=b.title,d.href=b.epubcfi,d.classList.add("search_link"),d.addEventListener("click",function(b){var c=this.getAttribute("href");a.gotoCfi(c),a.gotoCfi(c),b.preventDefault()},!1),c.appendChild(d),c};return this.settings.bookmarks.forEach(function(a){var b=h(a);d.appendChild(b)}),c.append(d),this.on("reader:addSearch",function(a){var b=h(a);c.append(b)}),this.on("reader:removeSearch",function(a){c.empty();}),{show:e,hide:f}},

    EPUBJS.reader.ControlsController = function (a) { var b = this, c = ($("#store"), $("#fullscreen")), d = ($("#fullscreenicon"), $("#cancelfullscreenicon"), $("#slider")), e = ($("#main"), $("#sidebar"), $("#setting")), f = $("#bookmark"), g = function () { b.offline = !1 }, h = function () { b.offline = !0 }, i = !1; return a.on("book:online", g), a.on("book:offline", h), d.on("click", function () { b.sidebarOpen ? (b.SidebarController.hide(), d.removeClass("fa-arrow-left"), d.addClass("fa-th-large")) : (b.SidebarController.show(), d.removeClass("fa-th-large"), d.addClass("fa-arrow-left")) }), "undefined" != typeof screenfull && (c.on("click", function () { screenfull.toggle($("#container")[0]) }), screenfull.raw && document.addEventListener(screenfull.raw.fullscreenchange, function () { i = screenfull.isFullscreen, i ? c.addClass("icon-resize-small").removeClass("icon-resize-full") : c.addClass("icon-resize-full").removeClass("icon-resize-small") })), e.on("click", function () { b.SettingsController.show() }),/* f.on("click", function () { var a = b.book.getCurrentLocationCfi(), c = b.isBookmarked(a); c === -1 ? (b.addBookmark(a), f.removeClass("glyphicon-star-empty").addClass("glyphicon-star")) : (b.removeBookmark(a), f.removeClass("glyphicon-star").addClass("glyphicon-star-empty")) }),*/ a.on("renderer:locationChanged", function (a) { var c = "#" + a, d = b.isBookmarked(a); d === -1 ? f.removeClass("fa-bookmark").addClass("fa-bookmark-o") : f.removeClass("fa-bookmark").addClass("fa-bookmark-o"), b.currentLocationCfi = a, b.settings.history && window.location.hash != c && history.pushState({}, "", c) }), a.on("book:pageChanged", function (a) { }), {} },
