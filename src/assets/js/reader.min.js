EPUBJS.reader = {}, EPUBJS.reader.plugins = {}, function (a, b) { var c = (a.ePubReader || {}, a.ePubReader = function (a, b) { return new EPUBJS.Reader(a, b) }); "function" == typeof define && define.amd ? define(function () { return Reader }) : "undefined" != typeof module && module.exports && (module.exports = c) }(window, jQuery),
    ...
    EPUBJS.reader.ControlsController = function (a) { var b = this, c = ($("#store"), $("#fullscreen")), d = ($("#fullscreenicon"), $("#cancelfullscreenicon"), $("#slider")), e = ($("#main"), $("#sidebar"), $("#setting")), f = $("#bookmark"), g = function () { b.offline = !1 }, h = function () { b.offline = !0 }, i = !1; return a.on("book:online", g), a.on("book:offline", h), d.on("click", function () { b.sidebarOpen ? (b.SidebarController.hide(), d.removeClass("glyphicon-arrow-left"), d.addClass("glyphicon-th-large")) : (b.SidebarController.show(), d.removeClass("glyphicon-th-large"), d.addClass("glyphicon-arrow-left")) }), "undefined" != typeof screenfull && (c.on("click", function () { screenfull.toggle($("#container")[0]) }), screenfull.raw && document.addEventListener(screenfull.raw.fullscreenchange, function () { i = screenfull.isFullscreen, i ? c.addClass("icon-resize-small").removeClass("icon-resize-full") : c.addClass("icon-resize-full").removeClass("icon-resize-small") })), e.on("click", function () { b.SettingsController.show() }),/* f.on("click", function () { var a = b.book.getCurrentLocationCfi(), c = b.isBookmarked(a); c === -1 ? (b.addBookmark(a), f.removeClass("glyphicon-star-empty").addClass("glyphicon-star")) : (b.removeBookmark(a), f.removeClass("glyphicon-star").addClass("glyphicon-star-empty")) }),*/ a.on("renderer:locationChanged", function (a) { var c = "#" + a, d = b.isBookmarked(a); d === -1 ? f.removeClass("glyphicon-star").addClass("glyphicon-star-empty") : f.removeClass("glyphicon-star").addClass("glyphicon-star-empty"), b.currentLocationCfi = a, b.settings.history && window.location.hash != c && history.pushState({}, "", c) }), a.on("book:pageChanged", function (a) { }), {} },
